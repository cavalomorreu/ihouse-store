...
$(document).ready(function () {
	...
	*/
	...
	/**
	 * 
	 * Oculta bloco de referência quando a variação for única
	 * 
	 * */
	let _references = $(".blocoVariacoes .variation-box");
	if (_references.length > 0) {
		_references.each(function () {
			if ($(this).find("input[type='radio']").length == 1) $(this).addClass("hideme");
		})
	}
