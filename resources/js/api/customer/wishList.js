    ...
    if (!userAuthentication.success) {
        ...
        if (inlist === 'false') {
            ...
            if (result.success === true) {
                ...
                $(element).find(".wishlist-item").removeClass('grey');
                $(element).find(".wishlist-item").addClass('red');
                $(element).find(".wishlist-item").attr('data-in-list', 'true');
            } else {
                $(element).find(".wishlist-item").removeClass('red');
                $(element).find(".wishlist-item").addClass('grey');
            ...
            if (result.success === true) {
                ...
                $(element).find(".wishlist-item").removeClass('red');
                $(element).find(".wishlist-item").addClass('grey');
                $(element).find(".wishlist-item").attr('data-in-list', 'false');
            } else {
                $(element).find(".wishlist-item").removeClass('grey');
                $(element).find(".wishlist-item").addClass('red');
                _alert("", result.message, "warning");
